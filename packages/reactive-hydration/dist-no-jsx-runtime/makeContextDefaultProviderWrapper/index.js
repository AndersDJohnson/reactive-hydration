...
function makeContextDefaultProviderWrapper(id, Provider, serializedValue, setContextValue) {
    var ContextDefaultProviderWrapper = function (props) {
        ...
        return ((0, global.jsx_runtime_1.jsx)(Provider, __assign({ id: id, value: value }, { children: children })));
    };
