...
exports.ReactiveHydrationContainerInner = (0, _react_1.memo)(
  function (props) {
    var _a;
    var importComponent = props.importComponent,
      importContext = props.importContext;
    ...
    var _c = __read(
      ...
      topmostContextPortalTreeEntries = _c[0];
    var _d = __read(
        (0, react_actual_1.useState)(function () {
          return [];
        }),
    ...
    var _e = __read(
      ...
      forcedRender = _e[0],
      setForcedRender = _e[1];
    var forceRender = (0, _react_1.useCallback)(function () {
      return setForcedRender({});
    }, []);
    var _f = __read(
        (0, react_actual_1.useState)(function () {
          return [];
      ...
      pendingCallbacks = _f[0],
      setPendingCallbacks = _f[1];
    var _g = __read(
        (0, react_actual_1.useState)(function () {
          return new Map();
        }),
      ...
      contextHydratorsByContextId = _g[0];
    var getSetContextValueByContextElement = (0, _react_1.useCallback)(
      function ($context) {
        return function (value) {
          ...
          __spreadArray(
            [],
            __read(
              (_a = contextHydratorsByContextId.get(contextId)) !== null &&
                _a !== void 0
                ? _a
                : []
            ),
            false
          ).forEach(function (hydrator) {
            if (hydrator.$context) {
    ...
    var hydrate = (0, _react_1.useCallback)(
      function (args) {
        return __awaiter(void 0, void 0, void 0, function () {
          var $component,
            ...
            handledIds,
            $currentComponent,
            previousComponentIndexByName,
            currentName,
            currentId,
            currentSerializedStateSelector,
            currentSerializedStateElement,
          ...
          return __generator(this, function (_j) {
            switch (_j.label) {
              case 0:
                ...
                id =
                  (_e = $component.dataset) === null || _e === void 0
                    ? void 0
                    : _e.id;
                name =
                  (_f = $component.dataset) === null || _f === void 0
                    ? void 0
                    : _f.component;
                ...
                console.debug.apply(
                  console,
                  __spreadArray(
                    ["Hydrating", name, $component, "due to:"],
                    __read(Array.isArray(reason) ? reason : [reason]),
                    false
                  )
                );
              ...
              case 1:
                ...
                hasHydratedAncestor = __spreadArray(
                  [],
                  __read(hydratedComponentsMap.keys()),
                  false
                ).some(function ($hydratedComponent) {
                  return (
                ...
                if (hasHydratedAncestor) {
                  if (callback) {
                    setPendingCallbacks(function (p) {
                      return __spreadArray(
                        __spreadArray([], __read(p), false),
                        [callback],
                        false
                      );
                    });
                ...
                while ($currentComponent) {
                  currentName =
                    $currentComponent === null || $currentComponent === void 0
                      ? void 0
                      : $currentComponent.dataset.component;
                  if (!currentName) continue;
                  currentId =
                    $currentComponent === null || $currentComponent === void 0
                      ? void 0
                      : $currentComponent.dataset.id;
                  if (!currentId) continue;
                  currentSerializedStateSelector = '[data-id="'.concat(
                    currentId,
                    '"][data-state]'
                  );
                  currentSerializedStateElement =
                  ...
                  currentSerializedState =
                    currentSerializedStateElement === null ||
                    currentSerializedStateElement === void 0
                      ? void 0
                      : currentSerializedStateElement.dataset.state;
                  currentComponentIndex =
                    ((_g = previousComponentIndexByName.get(currentName)) !==
                      null && _g !== void 0
                      ? _g
                      : -1) + 1;
                  ...
                  if (currentSerializedState) {
                    currentStateKey = ""
                      .concat(currentName, ".")
                      .concat(currentComponentIndex);
                    portalState[currentStateKey] = JSON.parse(
                      currentSerializedState
                    );
                  }
                  handledIds.push(currentId);
                  nextComponentSelector = "[data-component][data-id]".concat(
                    handledIds
                      .map(function (hid) {
                        return ':not([data-id="'.concat(hid, '"])');
                      })
                      .join("")
                  );
                  $nextComponent = $component.querySelector(
                    nextComponentSelector
                  );
                ...
                try {
                  for (
                    _a = __values(Object.entries(dataset)), _b = _a.next();
                    !_b.done;
                    _b = _a.next()
                  ) {
                    (_c = __read(_b.value, 2)),
                      (key_1 = _c[0]),
                      (value = _c[1]);
                ...
                while (true) {
                  ...
                  previousId =
                    $previous === null || $previous === void 0
                      ? void 0
                      : $previous.dataset.contextId;
                  $context =
                    $context === null || $context === void 0
                      ? void 0
                      : $context.closest("[data-context-value]");
                  if ($context) {
                  ...
                  contextName =
                    $context === null || $context === void 0
                      ? void 0
                      : $context.dataset.contextName;
                  if (!contextId) break;
                  if (!contextName) break;
                  contextPortalTreePath.push(
                    "".concat(contextName, "[").concat(contextId, "]")
                  );
                ...
                if ($topmostContext) {
                  topmostContextId =
                    $topmostContext === null || $topmostContext === void 0
                      ? void 0
                      : $topmostContext.dataset.contextId;
                          ...
                          switch (_a.label) {
                            case 0:
                              ...
                              serializedValue =
                                $context === null || $context === void 0
                                  ? void 0
                                  : $context.dataset.contextValue;
                              if (!contextName) return [2 /*return*/];
                              if (!serializedValue) return [2 /*return*/];
              ...
              case 2:
                ...
                contextMetas.forEach(function (contextMeta) {
                  var $context = contextMeta.$context,
                    Context = contextMeta.Context,
                    deserializedValue = contextMeta.deserializedValue;
                  var DefaultProvider = Context.DefaultProvider,
                  ...
                  var ContextDefaultProviderWrapper =
                  ...
                  if (!ContextDefaultProviderWrapper) {
                    ...
                    ContextDefaultProviderWrapper = (0,
                    makeContextDefaultProviderWrapper_1.makeContextDefaultProviderWrapper)(
                      contextId,
                      Provider,
                      deserializedValue,
                      setContextValue
                ...
                _j.label = 3;
              case 3:
                portal = (0, react_dom_1.createPortal)(
                  (0, global.jsx_runtime_1.jsx)(ImportedComponent, {
                ...
                key = __spreadArray(
                  __spreadArray([], __read(contextPortalTreePath), false),
                  ["".concat(name, "[").concat(id, "]")],
                  false
                ).join(" > ");
                closestContextId =
                  (_h =
                    $closestContext === null || $closestContext === void 0
                      ? void 0
                      : $closestContext.dataset) === null || _h === void 0
                    ? void 0
                    : _h.contextId;
    ...
    (0, _react_1.useEffect)(
      function () {
        var _a;
        var $components =
          (_a = componentRef.current) === null || _a === void 0
            ? void 0
            : _a.querySelectorAll("[data-component]");
        if (!$components) return;
        $components.forEach(function ($component) {
          var _a;
          var init =
            (_a = $component.dataset) === null || _a === void 0
              ? void 0
              : _a.init;
          if (init === "true") return;
    ...
    return (0, global.jsx_runtime_1.jsxs)(global.jsx_runtime_1.Fragment, {
      children: [
        ...
        __spreadArray(
          ...
          __read(
            (_a =
              topmostContextPortalTreeEntries === null ||
              topmostContextPortalTreeEntries === void 0
                ? void 0
                : topmostContextPortalTreeEntries.values()) !== null &&
              _a !== void 0
              ? _a
              : []
          ),
          false
        ).map(function (topmostContextPortalTreeEntry) {
          return (0,
          global.jsx_runtime_1
            .jsx)(ContextPortalTreeRenderer_1.ContextPortalTreeRenderer, { contextPortalTreeEntry: topmostContextPortalTreeEntry }, topmostContextPortalTreeEntry.key);
        }),
        contextFreePortals.map(function (portal) {
          return (0,
          global.jsx_runtime_1
            .jsx)(ReactiveHydrationInnardsContext_1.ReactiveHydrationInnardsContext.Provider, __assign({ value: undefined }, { children: (0, global.jsx_runtime_1.jsx)(_react_1.Fragment, { children: portal.portal }, portal.key) }));
        }),
      ],
    });
  },
...
exports.ReactiveHydrationContainerInner.displayName =
