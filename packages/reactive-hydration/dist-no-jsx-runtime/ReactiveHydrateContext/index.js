...
exports.ReactiveHydrateContextProvider = exports.ReactiveHydrateContext =
  void 0;
...
var ReactiveHydrateContextProvider = function (props) {
  var children = props.children,
    reactiveHydratingId = props.reactiveHydratingId,
    reactiveHydratePortalStateProp = props.reactiveHydratePortalState,
    usedHooksRef = props.usedHooksRef;
  var _a = __read(
    ...
    registry = _a[0];
  var reactiveHydratePortalStateContext = (0, react_actual_1.useContext)(
    exports.ReactiveHydrateContext
  ...
  var registerComponentPath = (0, _react_1.useCallback)(
    function () {
      var currentIndex = registry.get(name);
      var newIndex =
        (currentIndex !== null && currentIndex !== void 0 ? currentIndex : -1) +
        1;
  ...
  var unregisterComponentPath = (0, _react_1.useCallback)(
    function (name) {
      var currentIndex = registry.get(name);
  ...
  var reactiveHydrationComponentPathContextValue = (0, _react_1.useMemo)(
    function () {
      return {
  ...
  return (0, global.jsx_runtime_1.jsx)(
    exports.ReactiveHydrateContext.Provider,
    __assign(
