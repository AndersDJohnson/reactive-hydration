...
var ReactiveHydrate = function (props) {
  ...
  var reactiveHydratingId = (0, react_actual_1.useContext)(
    ReactiveHydrateContext_1.ReactiveHydrateContext
  ).reactiveHydratingId;
  var reactiveHydrationContainerContext = (0, react_actual_1.useContext)(
    ReactiveHydrationContainerContext_1.ReactiveHydrationContainerContext
  );
  var isWithinReactiveHydrationContainer = (
    reactiveHydrationContainerContext !== null &&
    reactiveHydrationContainerContext !== void 0
  ...
  if (!isWithinReactiveHydrationContainer) {
    return (0, global.jsx_runtime_1.jsx)(global.jsx_runtime_1.Fragment, {
  ...
  return (0, global.jsx_runtime_1.jsx)(global.jsx_runtime_1.Fragment, {
    children:
      typeof window !== "object" || !isHydratingSelf || forceHydrate
        ...
        : (0, global.jsx_runtime_1.jsx)(global.jsx_runtime_1.Fragment, {
            children: props.children,
          }),
  });
};
