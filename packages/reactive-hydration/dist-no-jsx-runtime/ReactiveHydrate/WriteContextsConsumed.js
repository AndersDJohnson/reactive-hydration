...
var WriteContextsConsumed = function () {
  var _a;
  var usedHooksRef = (0, react_actual_1.useContext)(
    ReactiveHydrateContext_1.ReactiveHydrateContext
  ).usedHooksRef;
  var setValues =
    (_a =
      usedHooksRef === null || usedHooksRef === void 0
        ? void 0
        : usedHooksRef.current) === null || _a === void 0
      ? void 0
      : _a.contexts.values();
  var contexts = setValues
    ? __spreadArray([], __read(setValues), false)
    : undefined;
  if (!(contexts === null || contexts === void 0 ? void 0 : contexts.length)) {
    return null;
  }
  return (0, global.jsx_runtime_1.jsx)("div", {
