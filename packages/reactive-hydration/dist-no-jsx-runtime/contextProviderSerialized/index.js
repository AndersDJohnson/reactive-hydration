...
function contextProviderSerialized(context) {
    var Provider = context.Provider, displayName = context.displayName;
    var ContextProviderSerialized = function (props) {
        var _a;
        var children = props.children, value = props.value, idProp = props.id;
        var hasSoftRouted = (0, react_actual_1.useContext)(ReactiveHydrationContainerContext_1.ReactiveHydrationContainerContext).hasSoftRouted;
        var serializedValue = (0, _react_1.useMemo)(function () { return JSON.stringify(value); }, [value]);
        var usedId = (0, _react_1.useId)();
        if (typeof window === "object" && !hasSoftRouted && !forceHydrate) {
            return (0, global.jsx_runtime_1.jsx)(Provider, __assign({ value: value }, { children: children }));
        }
        ...
        (_a = idProp !== null && idProp !== void 0 ? idProp : 
